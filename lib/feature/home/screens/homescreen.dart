...
final dishListsProvider=StateProvider<List<Product>>((ref) => []);
final refBoool = StateProvider((ref) => false);
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          drawer: ref.watch(userStreamProvider).when(
              data: (data) => Drawer(
                elevation: 0,
                child: ListView(
                    ...
                    ClipRRect(
                      borderRadius: BorderRadius.only(
                        bottomRight: Radius.circular(
                            width * .18), // Curve the bottom right corner
                      ),
                      child: DrawerHeader(
                        decoration: BoxDecoration(
                        ...
                        children: <Widget>[
                            ...
                            children: [
                              Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.asset('assets/images/bonda.jpeg',
                                      fit: BoxFit.cover),
                                ),
                              ),
                            ],
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                bottom: height * .05, left: width * .15),
                            child: Column(
                              children: [
                                Container(
                                  height: height * .035,
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(width *
                                        .04), // Adjust the borderRadius for rounded corners
                                    color: Colors
                                        .black, // Adjust the background color
                                  ),
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Icon(Icons.person_add,
                                          color: Colors.white,
                                          size:
                                          width * .03), // Icon before text
                                      SizedBox(
                                          width: width *
                                              .01), // Space between icon and text
                                      Text(
                                        'Follow',
                                        style: TextStyle(
                                            color: Colors.white,
                    ...
                    Container(
                      ...
                      child: TabBar(
                        indicator: BoxDecoration(
                          color: Colors.yellow
                              .shade600, // Set the background color of the selected tab
                        ...
                        tabs: [
                          Tab(
                              icon: Container(
                                width: width * .7,
                                child: Column(
                                  children: [Icon(Icons.list), Text('Wall')],
                                ),
                              )),
                          Tab(
                              icon: Container(
                          ...
                          Tab(
                              icon: Container(
                                width: width * .7,
                                child: Column(
                                  children: [Icon(Icons.videocam), Text('Videos')],
                                ),
                              )),
                          Tab(
                              icon: Container(
                          ...
                          Tab(
                              icon: Container(
                                width: width * .7,
                                child: Column(
                                  children: [Icon(Icons.book), Text('Blog')],
                                ),
                              )),
                        ],
                      ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.restaurant_menu,
                            color: Colors.white,
                            size: width * .03), // Icon before text
                        SizedBox(
                            width: width * .01), // Space between icon and text
                        Text(
                          'Browse Menu',
                          style: TextStyle(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Consumer(
                      builder:
                          (context,refDish,child) {
                        ref.watch(refBoool);
                        print("consumer Work aayi");
                        final dishList=refDish.watch(dishListsProvider);
                        return dishList.isNotEmpty
                            ? Text(
                            '${(dishList.length).toString()}'
                                ' Items',
                            style: TextStyle(fontSize: 18))
                            : Text('0 Items',style: TextStyle(fontSize: 18));
                      },
                    ),
                  ),
                  GestureDetector(
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => CheckOutPage(
                              dish: ref.watch(dishListsProvider),
                            ),
                          ));
                    },
                    child: Row(
